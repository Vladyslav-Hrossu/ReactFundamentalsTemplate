...
describe('CourseCard component', () => {
	it('should render the Delete and Update buttons for admin', () => {
		render(
			<Router>
	...
	it('should not render the Delete and Update buttons for non-admin', () => {
		const store = mockStore({
			authors,
			courses,
			user: { role: '' },
	...
	it('should render update button wrapped in Link', () => {
		render(
			<Router>
				<Provider store={store}>
					<CourseCard course={courses[0]} />
	...
	it('should call deleteCourseThunk on delete button click', () => {
